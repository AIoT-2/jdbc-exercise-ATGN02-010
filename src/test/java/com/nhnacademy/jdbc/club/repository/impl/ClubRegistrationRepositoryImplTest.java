...
class ClubRegistrationRepositoryImplTest {
    // todo#28 - ClubRegistrationRepositoryImplTest 실항하여 Test Case가 통과할 수 있도록
    // ClubRegistrationRepositoryImpl 구현합니다.
    ...
    void findClubStudents_full_join() {
        ...
        /*
         * 정렬은 하지 않습니다. mysql full join을 지원하지 않습니다. 대신 left join + right join 결과를 union을
         * 통해서 중복 제거한 합집합을 반환합니다.
         * select
         * a.id as student_id,
         * a.name as student_name,
         * c.club_id,
    ...
    void findClubStudents_outher_excluding_join() {
        ...
        /*
         * mysql은 full outher join을 제공하지 않음 , left excluding join + right excluding join
         * union해서 구할수 있음
         * 
         * select
         * a.id as student_id,
